    ...
    <div className="container flex flex-col justify-center h-screen p-8">
      <div className="p-8 space-y-4 max-w-lg mx-auto bg-blue-100 flex flex-col justify-center items-center">
        ...
        <div className="flex items-center">
          <label className="font-bold mr-2 w-20 text-right inline-block">{data?.AuthColumn1Title}</label>
          <input type="text" className="p-2 rounded outline-none focus:ring-1" />

        </div>
        <div  className="flex items-center">
          <label className="font-bold mr-2 w-20  inline-block">{data?.AuthColumn2Title}</label>
          <input type="text" className="p-2 rounded outline-none focus:ring-1" />
        </div>
